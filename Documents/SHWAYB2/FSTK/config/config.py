...
class config:
    ...
    def get_carol_alexander_book_data_path(self):
        carol_alexander_book_data_path = self.get_data_files_location() + 'carol_alexander_book'
        return carol_alexander_book_data_path
